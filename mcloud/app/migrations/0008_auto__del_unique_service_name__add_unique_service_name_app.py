...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'app_service', ['name'])

        # Adding unique constraint on 'Service', fields ['name', 'app']
        db.create_unique(u'app_service', ['name', 'app_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Service', fields ['name', 'app']
        db.delete_unique(u'app_service', ['name', 'app_id'])

        # Adding unique constraint on 'Service', fields ['name']
        db.create_unique(u'app_service', ['name'])
    ...
    models = {
        ...
        u'app.service': {
            'Meta': {'unique_together': "((u'name', u'app'),)", 'object_name': 'Service'},
            'app': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['app.Application']"}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'date_updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'})
