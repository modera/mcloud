...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'app_application', 'name',
                      self.gf('django.db.models.fields.CharField')(default=u'My app', unique=True, max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Application.name'
        db.delete_column(u'app_application', 'name')
