...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'app_service', (
            ...
            ('name', self.gf('django.db.models.fields.CharField')(default=u'My app', unique=True, max_length=255)),
            ('app', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Application'])),
        ))
        db.send_create_signal(u'app', ['Service'])


    def backwards(self, orm):
        # Deleting model 'Service'
        db.delete_table(u'app_service')
